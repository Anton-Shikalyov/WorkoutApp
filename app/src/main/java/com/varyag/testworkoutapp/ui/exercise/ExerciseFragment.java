...
public class ExerciseFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        CustomAdapter adapter = new  CustomAdapter(this.getContext(), R.layout.spinner_text, R.layout.spinner_text_dropdown, LevelList.list);
        ...
        exerciseViewModel.getWorkoutItems().observe(getViewLifecycleOwner(), workoutItems -> {
            ...
            title.setText(workoutItems.get(0).title);
